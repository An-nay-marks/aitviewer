...
from projectaria_tools.core.calibration import CameraModelType
    ...
    for sensor in sensor_data.keys():
        if sensor != "camera-rgb":
            ...
            if visualize_images: # Project images into Camera
                ...
                pinhole_calibration_for_undistortion = calibration.get_linear_camera_calibration(original_image_size[0], original_image_size[1], focal_length)
